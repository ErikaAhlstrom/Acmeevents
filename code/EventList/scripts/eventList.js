...
class itemLister{
    ...
    printEventDetails() {
        ...
        for(let i = 0; i < this.eventListItems.length; i++) {
            ...
            //Ge Event info:
            categoryCompanyHeader.textContent = this.globalArr[i].category + ", " + this.globalArr[i].companyName;
            ...
            startsP.textContent = "Starts: " + this.globalArr[i].startDate + ", " + this.globalArr[i].startTime;
...
class itemLister {
  ...
  listEvents(events) {
    ...
    for (let current of events) {
      ...
      eventListDateP.innerHTML = current.startDate;
      eventListNameH4.innerHTML = current.category;
>>>>>>> 5fe3c0073298bec0105e74ddbc28eed76404225e
    }
  }
